...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('decks_deck', 'description', self.gf('django.db.models.fields.TextField')(max_length=10, null=True))
    ...
    models = {
        ...
        'decks.deck': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),

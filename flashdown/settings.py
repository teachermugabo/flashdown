...
SECRET_KEY = '0lc+w)8##s47gmd3v-(v^imsxnvyuo49andy1dr0hp&amp;4x%v@v1'
...
ROOT_URLCONF = 'flashdown.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'flashdown.wsgi.application'
...
TEMPLATE_DIRS = (
    ...
    os.path.join(DECK_ROOT, 'templates'),
)
...
INTERNAL_IPS = ('127.0.0.1',) # needed for debug_toolbar
